...
export const commandCatalog: CommandDoc[] = [
  ...
  { name: "EVAL_RO", group: "scripting", arity: -3, summary: "Run a read-only Lua script on the server", since: "7.0.0", access: "read", args: [{ name: "script", type: "string" }, { name: "numkeys", type: "int" }, { name: "key", type: "key", multiple: true }, { name: "arg", type: "string", multiple: true }] },
  { name: "EVALSHA_RO", group: "scripting", arity: -3, summary: "Run a cached read-only Lua script by its SHA1", since: "7.0.0", access: "read", args: [{ name: "sha1", type: "string" }, { name: "numkeys", type: "int" }, { name: "key", type: "key", multiple: true }, { name: "arg", type: "string", multiple: true }] },
  ...
  { name: "FCALL_RO", group: "scripting", arity: -3, summary: "Run a read-only server-side function", since: "7.0.0", access: "read", args: [{ name: "function", type: "string" }, { name: "numkeys", type: "int" }, { name: "key", type: "key", multiple: true }, { name: "arg", type: "string", multiple: true }] },
